    ...
    return (
        <div className="Winnica">
            <Helmet>
                ...
                <meta property="og:description" content="Odkryj smaki regionu z Winnicą Zamojską. Degustacje win i lokalnych produktów w sercu Lubelszczyzny." />
                <meta property="og:image" content="https://phupierrot.pl/img/Degustacja.webp" />
            </Helmet>

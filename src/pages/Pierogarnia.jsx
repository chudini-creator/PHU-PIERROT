...
function Pierogarnia(){
    return(
        <div className="pierogarnia">
            <Hero title="Pierogarnia" bgImage="/img/pierogarnia.jpg"/>
            ...
            <div className="pierogarnia_content">
                <div className="pierogarnia_photos">
                    <img src="/img/pierogarnia.jpg" alt="pierogarnia" className="pierogarnia_photo"/>
                    <img src="/img/pierogarnia2.jpg" alt="pierogarnia" className="pierogarnia_photo"/>
                </div>
